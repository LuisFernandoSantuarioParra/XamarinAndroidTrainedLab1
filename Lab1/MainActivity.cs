...
namespace Lab1
{
    ...
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            textViewDev = FindViewById<TextView>(Resource.Id.textView1);
        ...
        {
            textViewDev.Text = "Luis Fernando Santuario Parra";
            string myDevice = Android.Provider.Settings.Secure.GetString(ContentResolver, Android.Provider.Settings.Secure.AndroidId);
            XamarinDiplomado.ServiceHelper helper = new XamarinDiplomado.ServiceHelper();
            await helper.InsertarEntidad("shadowghost-1996@hotmail.com","lab1",myDevice);
